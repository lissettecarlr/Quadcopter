...
//发送
  //飞机姿态基本信息 pit、yaw、rol三个数据将会放大100倍后上传
	...
	bool SendSensorOriginalData(Vector3<int> acc, Vector3<int> gyro,Vector3<int> mag);
		//接收到的控制量
	bool SendRcvControlQuantity(float aux1,float aux2,float aux3,float aux4,float aux5,float aux6);
		//发送PID数据
